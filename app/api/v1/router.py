...
from app.api.v1.endpoints import academic, admissions, attendance, auth, certificates, exams, fees, hostel, hr, library, roles, site_content, students, transport, users
